...
>
  <head>
    ...
    <title>Login Basic - Pages | Payroll - Bootstrap 5 HTML Admin Template - Pro</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Payroll</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Sneat Payroll! 👋</h4>
              ...
              <?= form_open('') ?>
                <div class="mb-3">
                  ...
                  <input
                    ...
                    value="<?= set_value('euc') ?>"
                    name="euc"
                    placeholder="Enter your email, contact or username"
                    autofocus
                  /><p class="text-danger"><?= form_error('euc'); ?></p>
                </div>
