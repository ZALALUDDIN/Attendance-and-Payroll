...
>
  <head>
    ...
    <title>Register Basic - Pages | Sneat Payroll- Bootstrap 5 HTML Admin Template - Pro</title>
      ...
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Sneat Payroll</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Adventure starts here 🚀</h4>
              <p class="mb-4">Make a Registration</p>
            ...
            <?php }} ?>
                  </select><span class="text-danger"><?= form_error('role'); ?></span>
                </div>
                <div class="mb-3">
                ...
                </div><span class="text-danger"><?= form_error('email'); ?></span>
                ...
                </div><span class="text-danger"><?= form_error('contact'); ?></span>
                ...
                <div class="mb-3">
                  ...
                  name="uname" 
                  placeholder="Enter your username" />
                </div><span class="text-danger"><?= form_error('uname'); ?></span>
                ...
                <div class="mb-3 form-cpassword-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    /><span class="text-danger"><?= form_error('cpwd'); ?></span>
                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                  </div>
                </div>
